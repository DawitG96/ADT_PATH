...
void test_create_destroy()
{
    ...
    ht = upo_ht_sepchain_create(UPO_HT_SEPCHAIN_DEFAULT_CAPACITY, upo_ht_hash_str_kr2e, str_compare);
...
void test_put_get_delete()
{
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &keys1[i], &values[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
        ...
        value = upo_ht_sepchain_get(ht, &keys1[i]);
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &keys1[i], &values_upd[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &keys2[i], &values[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
        ...
        value = upo_ht_sepchain_get(ht, &keys2[i]);
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &keys2[i], &values_upd[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    for (i = 0; i < n; ++i)
    {
        ...
        value = upo_ht_sepchain_get(ht, &keys3[i]);
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &keys3[i], &values_upd[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    /* HT: mix with interleaved put/get/delete */
    ...
    /* HT: duplicates */
    {
        ...
        ht = upo_ht_sepchain_create(M, upo_ht_hash_int_div, int_compare);

        assert( ht != NULL );

        upo_ht_sepchain_put(ht, &key1, &value);

        upo_ht_sepchain_put(ht, &key2, &value);

        upo_ht_sepchain_put(ht, &key3, &value);

        upo_ht_sepchain_delete(ht, &key2, 0);
...
void test_insert_get_delete()
{
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_insert(ht, &keys1[i], &values_upd[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_insert(ht, &keys2[i], &values_upd[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_insert(ht, &keys3[i], &values[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_insert(ht, &keys3[i], &values_upd[i]);
    }
    /* Search */
    for (i = 0; i < n; ++i)
    {
    ...
    /* HT: mix with interleaved insert/get/delete */
    ...
    /* HT: duplicates */
    {
        ...
        upo_ht_sepchain_insert(ht, &key1, &value);

        upo_ht_sepchain_insert(ht, &key2, &value);

        upo_ht_sepchain_insert(ht, &key3, &value);
...
void test_clear()
{
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &keys[i], &values[i]);
    }

    assert( !upo_ht_sepchain_is_empty(ht) );
...
void test_empty()
{
    ...
    upo_ht_sepchain_put(ht, &key1, &value1);
    ...
    upo_ht_sepchain_put(ht, &key1, &value1);
    upo_ht_sepchain_put(ht, &key2, &value2);

    assert( !upo_ht_sepchain_is_empty(ht) );

    upo_ht_sepchain_delete(ht, &key1, 0);
...
void test_size()
{
    ...
    assert( upo_ht_sepchain_size(ht) == 0 );
...
void test_hash_funcs()
{
    ...
    for (i = 0; i < n; ++i)
    {
        ...
        value = upo_ht_sepchain_get(ht, &int_keys[i]);
    ...
    ht = upo_ht_sepchain_create(UPO_HT_SEPCHAIN_DEFAULT_CAPACITY, upo_ht_hash_int_mult_knuth, int_compare);
    ...
    for (i = 0; i < n; ++i)
    {
        upo_ht_sepchain_put(ht, &str_keys[i], &values[i]);
    }
    ...
    for (i = 0; i < n; ++i)
    {
        ...
        value = upo_ht_sepchain_get(ht, &str_keys[i]);
