 ...
 * Worst-case complexity: linear in the number `n` of elements, `O(n)`.
 */
void* upo_bst_put(upo_bst_t tree, void* key, void* value); /* OK */ 
 ...
 * Worst-case complexity: linear in the number `n` of elements, `O(n)`.
 */
void* upo_bst_get(const upo_bst_t tree, const void* key); /* OK */ 
 ...
 * Worst-case complexity: linear in the number `n` of elements, `O(n)`.
 */
int upo_bst_contains(const upo_bst_t tree, const void* key); /* OK */ 
 ...
 * Worst-case complexity: linear in the number `n` of elements, `O(n)`.
 */
void upo_bst_insert(upo_bst_t tree, void* key, void* value);  /* OK */
 ...
 * Worst-case complexity: linear in the number `n` of elements, `O(n)`.
 */
size_t upo_bst_size(const upo_bst_t tree); /* OK */
 ...
 * Worst-case complexity: constant, `O(1)`.
 */
int upo_bst_is_empty(const upo_bst_t tree); /* OK*/
 ...
 * \param visit_arg An additional parameter to pass to the visit function
 *
